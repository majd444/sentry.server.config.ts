...
"[project]/app/integrations/discord/page.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
;
function DiscordIntegrationPage({ searchParams }) {
    ...
    const resolvedSearchParams = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["use"])(searchParams);
    const agentId = (resolvedSearchParams?.agentId || '').trim();
    ...
    const fetchConfig = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async ()=>{
        try {
            const response = await fetch(`/api/discord/bot-config?agentId=${agentId}`);
    ...
    const inviteUrl = config ? `https://discord.com/api/oauth2/authorize?client_id=${config.clientId}&permissions=2048&scope=bot` : '';
    if (!user) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
//# sourceMappingURL=_13f6c397._.js.map