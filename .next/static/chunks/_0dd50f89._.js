...
"[project]/components/providers/convex-provider.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
;
const hasClerkEnv = !!("TURBOPACK compile-time value", "pk_test_bWVldC1xdWV0emFsLTkyLmNsZXJrLmFjY291bnRzLmRldiQ");
...
function createConvexClient() {
    ...
    const convexUrl = ("TURBOPACK compile-time value", "https://effervescent-mandrill-295.convex.cloud");
    ...
    try {
        ...
        const options = {
            unsavedChangesWarning: "object" !== 'undefined',
            verbose: ("TURBOPACK compile-time value", "development") === 'development'
        };
        // Only add webSocketConstructor if window is defined
        if ("TURBOPACK compile-time truthy", 1) {
            options.webSocketConstructor = WebSocket;
        }
        return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$convex$2f$dist$2f$esm$2f$react$2f$client$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ConvexReactClient"](convexUrl, options);
    } catch (error) {
...
function ConvexClientProvider(param) {
    ...
    const convexClient = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ConvexClientProvider.useMemo[convexClient]": ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ConvexClientProvider.useEffect": ()=>{
            ...
            const testConnection = {
                "ConvexClientProvider.useEffect.testConnection": async ()=>{
                    try {
                        console.log('🔍 [Convex] Testing connection...');
                        const testResult = await convexClient.query(__TURBOPACK__imported__module__$5b$project$5d2f$convex$2f$_generated$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].testQueries.getAuthStatus);
            ...
            }["ConvexClientProvider.useEffect.testConnection"];
            testConnection();
            // Test connection every 5 minutes
            const interval = setInterval(testConnection, 5 * 60 * 1000);
            return ({
                "ConvexClientProvider.useEffect": ()=>clearInterval(interval)
            })["ConvexClientProvider.useEffect"];
        }
    }["ConvexClientProvider.useEffect"], [
        convexClient
    ...
    if (!convexClient) {
        ...
        const ErrorDisplay = ()=>{
            ...
            if (!mounted) {
                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    fileName: "[project]/components/providers/convex-provider.tsx",
                    lineNumber: 98,
                    columnNumber: 16
                }, this); // Empty div during SSR
            }
            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "bg-destructive/10 border border-destructive/30 rounded-lg p-6 max-w-md mx-auto",
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                                    className: "text-lg font-semibold text-destructive",
                                    children: "Convex Initialization Error"
                                }, void 0, false, {
                                    fileName: "[project]/components/providers/convex-provider.tsx",
                                    lineNumber: 105,
                                    columnNumber: 15
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    className: "text-sm text-destructive/90 mt-2",
                                    children: "Failed to initialize the Convex client. Please check the following:"
                                }, void 0, false, {
                                    fileName: "[project]/components/providers/convex-provider.tsx",
                                    lineNumber: 108,
                                    columnNumber: 15
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("ul", {
                                    className: "list-disc pl-5 mt-2 space-y-1 text-sm text-left",
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                            children: "Verify NEXT_PUBLIC_CONVEX_URL is set in your .env.local file"
                                        }, void 0, false, {
                                            fileName: "[project]/components/providers/convex-provider.tsx",
                                            lineNumber: 112,
                                            columnNumber: 17
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                            children: "Ensure the Convex deployment is running"
                                        }, void 0, false, {
                                            fileName: "[project]/components/providers/convex-provider.tsx",
                                            lineNumber: 113,
                                            columnNumber: 17
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                            children: "Verify Clerk authentication is properly configured"
                                        }, void 0, false, {
                                            fileName: "[project]/components/providers/convex-provider.tsx",
                                            lineNumber: 115,
                                            columnNumber: 17
        ...
        _s2(ErrorDisplay, "LrrVfNW3d1raFE0BNzCTILYmIfo=");
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(ErrorDisplay, {}, void 0, false, {
            fileName: "[project]/components/providers/convex-provider.tsx",
            lineNumber: 129,
            columnNumber: 12
        }, this);
    ...
    const LoadingSpinner = ()=>{
        ...
        const [mounted, setMounted] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
            "ConvexClientProvider.LoadingSpinner.useEffect": ()=>{
                setMounted(true);
            }
        }["ConvexClientProvider.LoadingSpinner.useEffect"], []);
    ...
    _s1(LoadingSpinner, "LrrVfNW3d1raFE0BNzCTILYmIfo=");
...
_s(ConvexClientProvider, "YoQjtmsDaAoyU35n5G4wDme5KLM=");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$providers$2f$convex$2d$provider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/providers/convex-provider.tsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
'use client';
;
...
function Providers(param) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$nextjs$2f$dist$2f$esm$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["ClerkProvider"], {
        appearance: {
            baseTheme: theme === 'dark' ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$themes$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["dark"] : undefined,
            elements: {
        ...
        children: [
            toasts.map(function(param) {
                ...
                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$toast$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Toast"], {
                    ...props,
                    className: "".concat(theme === 'dark' ? 'dark' : ''),
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(Toaster, "CcXx5m43/DFT5XYe7Wald+hzd1c=", false, function() {
    return [
...
//# sourceMappingURL=_0dd50f89._.js.map